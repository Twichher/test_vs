...
interface MessageDetailVerificationProps {
  notification: NotificationItem;
  onClose: () => void;
}

export default function MessageDetailVerification({ notification, onClose }: MessageDetailVerificationProps) {
    ...
    <div className="message-detail message-detail--verification">
      ...
      <div className="message-detail__content verification-content">
        ...
        <div className="verification-welcome">
          <h2 className="verification-title">Благодарим тебя за регистрацию на VSTRECHI.RU!</h2>
          <p className="verification-subtitle">
            Для завершения регистрации тебе необходимо прислать нам твои фотографии: одна из них —{' '}
            <strong>лицо в анфас</strong> (глаза смотрят точно в объектив) и одна фотография —{' '}
            <strong>в профиль</strong> (сбоку).
          </p>
          <p className="verification-text">
            Это нужно для твоей же безопасности, ведь остальные пользователи системы проходили то же самое 😉
          </p>
        </div>
        ...
        <p className="verification-footer-text">
          <strong>Наконец всё!</strong> Все пункты регистрации ты выполнил. Когда проверка завершится, ты сможешь посещать встречи.
        </p>
        <p className="verification-text">
          Приносим извинения за неудобства, но безопасность и комфорт превыше всего.
        </p>
      </div>
    </div>
  );
